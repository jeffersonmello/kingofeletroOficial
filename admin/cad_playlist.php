                                 ...
                                 <div class="modal-body">
                                   <form name="inserir" id="inserir" method="post" action="inserir-playlist.php">
                                     ...
                                     <div class="form-group">
                                       ...
                                       <input name="arte" type="text" value="-" class="form-control" id="arte" placeholder="diretorio da imagem do album" />
                                     </div>
                                     ...
                                     <div class="form-group">
                                       ...
                                       <input name="album" type="text"  value="Unknow" class="form-control" id="album" placeholder="album desta música" />
                                     </div>

                                     <div class="form-group">
                                       <label for="exampleInputEmail1">Link Play</label>
                                       <input name="linkplay" type="text" value="<?php echo $proximamusica ?>" class="form-control" id="linkplay" placeholder="link da musica" />
                                     </div>
