                                 ...
                                 <div class="modal-body">
                                   <form name="inserir" id="inserir" method="post" action="inserir-musica.php">
                                     ...
                                     <div class="form-group">
                                       ...
                                       <input name="texto" type="text" value="Faça o download ou ouça esta música" class="form-control" id="texto" placeholder="Faça o download ou ouça esta música" />
                                     </div>
                                     ...
                                     <div class="form-group">
                                       ...
                                       <input name="nomearquivo" type="text" value="-" class="form-control" id="nomearquivo" placeholder="Ex: avicii.mp3" />
                                     </div>
