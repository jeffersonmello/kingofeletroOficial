...
<body>
                        ...
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li><a class="menu-section menu-top-active" href="cad-musicaradio.php">Cadastro de Musicas da Rádio</a></li>
                                <li><a class="menu-section" href="#">Cadastro de Noticias</a></li>
                              </ul>
                            </li>
                            <li><a  href="cad_musicaradio.php">Ligar Radio</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line">Rádio Musics</h4>
                </div>
                        ...
                        <div id="top" class="row">
                          <div class="col-md-3">
                             ...
                             <div class="col-md-3 pull-right">
                              <a href="add.html" class="btn btn-primary pull-right h2" data-toggle="modal" data-target="#myModal" >Nova Música Rádio</a>
                             </div>
                        </div> <!-- /#top -->
...
echo                  "<input name='artista' type='text' class='form-control' id='artista' value='$artista1' placeholder='Faça o download ou ouça esta música' />";
echo                "</div>";

echo                "<div class='form-group'>";
echo                  "<label for='exampleInputEmail1'>URL</label>";
echo                  "<input name='URL' type='text' class='form-control' id='URL' value='$url1' placeholder='Link de download' />";
echo                "</div>";
...
echo            "</div>";
echo            "<div class='modal-body'>";
echo              "<form name='inserir' id='inserir' method='post' action='editar-musicaradio.php'>";
...
echo            "</div>";
echo            "<div class='modal-body'>";
echo              "<form name='inserir' id='inserir' method='post' action='delete-musicaradio.php'>";
echo                "<div style='display:none' class='form-group'>";
                         ...
                         <div class="modal-dialog">
                             <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                   <form name="inserir" id="inserir" method="post" action="inserir-musicaradio.php">
                                     ...
                                     <div class="form-group">
                                       ...
                                       <input name="artista" type="text" class="form-control" id="artista"  />
                                     </div>
