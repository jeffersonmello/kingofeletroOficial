                                 ...
                                 <div class="modal-body">
                                   <form name="inserir" id="inserir" method="post" action="inserir-download.php">
                                     ...
                                     <div class="form-group">
                                       ...
                                       <input name="artista3" type="text" class="form-control" id="artista3" placeholder="Titulo da Música" />
                                     </div>

                                     <div class="form-group">
                                       <label for="exampleInputEmail1">Link de Download</label>
                                       <input name="downloadlink3" type="text" class="form-control" id="downloadlink3" placeholder="Faça o download ou ouça esta música" />
                                     </div>

                                     <div class="form-group">
                                       <label for="exampleInputEmail1">Download Torrent</label>
                                       <input name="torrent" type="text" class="form-control" id="torrent" placeholder="Titulo da Música" />
                                     </div>
